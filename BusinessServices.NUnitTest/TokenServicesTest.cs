    ...
    public class TokenServicesTest
    {
        ...
        private GenericRepository<Token> SetUpTokenRepository()
        {
            ...
            mockRepo.Setup(p => p.Insert((It.IsAny<Token>())))
                ...
                {
                    int maxTokenID = _tokens.Last().TokenId;
                    int nextTokenID = maxTokenID + 1;
        ...
        public void GenerateTokenByUserIdTest()
        {
            ...
            //referencia: https://www.c-sharpcorner.com/code/2402/assert-property-values-for-two-objects-or-two-lists.aspx
